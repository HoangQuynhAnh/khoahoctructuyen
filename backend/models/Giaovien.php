...
class Giaovien extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['hoten', 'noicongtac', 'monday', 'gioitinh','hocvi','diachi', 'fb', 'gioithieu', 'anh', 'ngaysinh', 'ngaytao','password','role', 'ngaycapnhat','status'], 'safe']
        ];
    }
    ...
    public function save()
    {
        ...
        $user->password_hash=password_hash($model->username, PASSWORD_DEFAULT);
